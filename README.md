...
- **`src/prompts/`**: Contains system prompts and AI instructions
  - `system-prompts.ts` — Comprehensive Theia Fraud Intelligence system prompt with 15-phase pipeline, MARAG framework definitions, benchmarking specifications, and operational principles
