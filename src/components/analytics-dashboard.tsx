    ...
    <div class="space-y-4 animate-fade-in">
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm text-zinc-600 dark:text-zinc-400 mt-1">
              Real-time fraud detection metrics, risk analysis, and system
              insights
            </p>
          </div>
          <button
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <StatsCard
          ...
          color="green"
          trend={
            stats.successRate > 80 ? { value: 5, isPositive: true } : undefined
          }
        />
        <StatsCard
      ...
      <div class="bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg p-4 mb-4 transition-colors">
        <div class="flex items-center justify-between mb-3">
          <div class="flex items-center gap-x-2">
            <MessageSquare size={20} strokeWidth={2} class="text-indigo-500" />
            <h3 class="text-lg font-semibold text-zinc-900 dark:text-white">
              Saved Chat Sessions
            </h3>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div class="flex items-center gap-x-1 mt-2">
                      ...
                      <button
                        onClick={() => {
                          const { exportSessionAsJSON } = require("@/signals");
                      ...
                      <button
                        onClick={() => {
                          const { exportSessionAsCSV } = require("@/signals");
                      ...
                      <button
                        onClick={() => {
                          ...
                          if (tag) {
                            const { addTagToSession } = require("@/signals");
